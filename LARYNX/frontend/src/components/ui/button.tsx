...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#38BDF8] text-black hover:bg-[#38BDF8]/80",
        destructive: "bg-[#DC2626] text-white hover:bg-[#DC2626]/90",
        outline: "border border-[#1F1F1F] bg-transparent hover:bg-[#0A0A0A] text-[#EDEDED]",
        secondary: "bg-[#0A0A0A] text-[#EDEDED] border border-[#1F1F1F] hover:bg-[#1F1F1F]",
        ghost: "hover:bg-[#0A0A0A] hover:text-[#EDEDED]",
